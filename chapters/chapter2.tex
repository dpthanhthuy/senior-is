...
\vspace{-.2 in}
\caption{Object Scanner target image. (Image from the Vuforia Object Scanner APK.)}\label{scanner_target}
\end{center}
\end{minipage}
}
\end{figure}
...
\vspace{-.2 in}
\caption{A scan in progress. (Screen capture by Thuy Dinh from the Vuforia Object Scanner app.)}\label{scan}
\end{center}
\end{minipage}
}
\end{figure}
