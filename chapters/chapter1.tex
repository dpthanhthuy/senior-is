...
\begin{defn}[Perspective projection]\label{perspectiveprojection}
\begin{equation}
M = K [R | t]
...
\begin{defn}[Direct linear transformation]\label{dlt}
\begin{equation}
...
%to do: add concluding paragraph. Maybe start with a different intro and move digital humanities down here.
